package net.dkahn.starter.apps.webapps.common.config;

import net.dkahn.starter.apps.webapps.common.utils.ResourceMessageReaderUtils;
 ...
 * Goal:
 */
public class CustomReloadableResourceMessageSource extends AbstractMessageSource implements ResourceLoaderAware {
    ...
    private PropertiesPersister propertiesPersister = new PropertiesPersister();
    ...
    protected Properties loadProperties(Resource resource, String filename) throws IOException {
        ...
        try {
            ...
            }else if (resource.getFilename().endsWith(JSON_SUFFIX)) {
                if (logger.isDebugEnabled()) {
                    logger.debug("Loading properties [" + resource.getFilename() + "]");
                }
    ...
    public void clearCacheIncludingAncestors() {
        clearCache();
        if (getParentMessageSource() instanceof CustomReloadableResourceMessageSource) {
            ((CustomReloadableResourceMessageSource) getParentMessageSource()).clearCacheIncludingAncestors();
        }
    }
...
class PropertiesPersister implements org.springframework.util.PropertiesPersister {
    ...
    public void loadFromYaml(Properties props, InputStream is) throws IOException {
        props.putAll(ResourceMessageReaderUtils.yamlToMap(is));
    }


    public void loadFromJson(Properties props, InputStream is) throws IOException {
        props.putAll(ResourceMessageReaderUtils.jsonToMap(is));
    }
